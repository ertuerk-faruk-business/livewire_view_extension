<div class="p-12 flex-col hidden xl:flex">
    <div class="flex flex-row justify-between items-start pr-4">
        ...
        <a href="#art" class="text-base tracking-widest font-bold uppercase text-slate-300 flex flex-row justify-center items-center space-x-2">
            <div>
                Unsere Arbeit
            </div>
            <x-svg.down class="w-6 h-6 animate-pulse"/>
        </a>
    </div>
