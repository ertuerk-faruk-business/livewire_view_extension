<header id="header" class="relative w-screen h-screen hidden xl:block">
    <div class="absolute w-full h-full z-0 transform">
        <div class="images-area images-area--xl w-full h-full flex flex-row">
    ...
    <div class="absolute w-full h-full bg-black bg-opacity-60 p-12 flex flex-col justify-between">
        ...
        <div class="flex flex-col items-start">
            <div class="text-6xl 2xl:text-8xl tracking-widest font-bold uppercase fade-in--delay-5">
