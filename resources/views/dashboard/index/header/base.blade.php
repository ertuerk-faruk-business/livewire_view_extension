<header id="header" class="relative w-screen h-screen-70 md:hidden">
    <div class="absolute w-full h-full z-0 transform">
        <div class="images-area images-area--base w-full h-full flex flex-row">
    ...
    <div class="absolute w-full h-full bg-black bg-opacity-60 p-6 flex flex-col justify-between">
        <nav class="flex flex-row items-start w-full justify-between relative">
            <div class="flex flex-row space-x-6 items-start fade-in">
                <div class="text-sm tracking-widest uppercase font-bold">
        ...
        <div class="flex flex-col items-start">
            <div class="text-3xl tracking-widest font-bold uppercase fade-in--delay-5">
                Expert Tattoos<br>& Piercings
            </div>
            <div class="flex flex-col items-start mt-6">
                <div class="flex flex-col items-start fade-in--delay-75">
                    <a href="tel:+491736660101" target="_blank" class="text-lg tracking-widest font-bold uppercase">
                        Termin vereinbaren
                    </a>
        ...
        <a target="_blank" href="https://maps.google.com/maps?q=Million Arts Tattoo, Holm 57-61, 24937 Flensburg" class="absolute -rotate-90 transform text-xs tracking-widest font-bold uppercase text-slate-300 -right-6 m-auto text-center top-1/2 flex flex-row justify-center items-center space-x-2">
